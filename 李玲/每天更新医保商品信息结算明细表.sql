...
--           and cyb.BUSNO in (81499,81501,84576)
        and  cyb.销售日期 between P_CurrentDate and P_CurrentDate+1
...
--     AND TO_DATE('20240104 07:10:00', 'YYYYMMDD HH24:MI:SS')
     ...
     a2 as (select BUSNO, CLASSNAME, SALENO, WAREID,MAKENO,INVALIDATE, WAREQTY, NETAMT, NETPRICE, WE_SCHAR01, 门店诊所医保支付价,
                   医保超限价, EXT_CHAR08,
                   case
...
select  a2.BUSNO, a2.CLASSNAME, a2.SALENO, a2.WAREID,a2.WAREQTY,a2.MAKENO,a2.INVALIDATE, a2.NETAMT as 实价金额, a2.NETPRICE as 实价,
       a2.WE_SCHAR01,
       a2.医疗费用自费总额,
       单据明细医保比例,
       整单统筹支付数,
