...
h.CREATETIME as 疾病首次确诊时间, a.ACCDATE as 首次输注购买帕妥或曲妥的时间,
DOCTORNAME as 首诊医院, fi.患者非本店购药帕妥或曲妥支数,
...
where rn = 1;
alter table d_patient_files add 患者非本店购药帕妥或曲妥支数 number;
