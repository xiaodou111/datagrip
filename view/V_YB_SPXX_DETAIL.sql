...
SELECT a.BUSNO, s.ORGNAME, a.CLASSNAME as 业务机构类型, a.SALENO, a.RECEIPTDATE as ACCDATE, cyb.销售日期,
       cyb.结算交易流水号,
       ...
       c03.CLASSNAME as 剂型, c12.CLASSNAME as 集团管理类别, c26.CLASSNAME as 医保招标分类,
       c810.CLASSNAME as 双通道分类,
