create or replace PROCEDURE cproc_coupon_618_rsv(p_compid IN t_ware.compid%TYPE,
           ...
           --插入券信息 原价满减券
                INSERT INTO T_CASH_COUPON_INFO
                  ...
                  SELECT V_COUPONNO,
                         ...
                         SYSDATE,
                         p_saleno,
                         2 as COUPON_KIND,--1现金券，2折扣券，4定价券
                         0,
                         p_busno,
                         1 ,
                         wareid,
