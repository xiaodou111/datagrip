...
f.lastmodify,f.lasttime,case when  pay.saleno is null then 0 else 1 end as ifyb,nvl(tr.iffugou,f.iffugou) as iffugou,
...
on  trim(tr.username)=oo.kk and tr.cfno=oo.cfno
 WHERE(   a.accdate+b.hf_day  >= to_date('2023-08-08', 'yyyy-MM-dd') 
and  a.accdate+b.hf_day < to_date('2023-08-09', 'yyyy-MM-dd')  ) 
